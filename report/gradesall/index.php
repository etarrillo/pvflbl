			...
			if($firstcat!=$grade->category){
	            ...
	            $html.='
							<div style="border:1px solid #858585;" class="fb-table-header fb-txt-green">
								...
								<span style="text-align:center;" class="fb-ancho20">Inicio</span>
								<span style="text-align:center;" class="fb-ancho20">Fin</span>
								<span style="text-align:center;" class="fb-ancho10">Calificación</span>
							</div>';
				    ...
				    $groupini = $DB->get_record_sql($sql_group, array($grade->courseid,$USER->id,'ini',$idgroup));
	                    ...
	                    $html.='<div class="fb-table-body">
								<span class="fb-ancho40">
									...
									<p class="fb-parrafo-curso-calificacion"><a href="" class="fb-txt-green">'.$grade->course.'</a></p>
								</span>

								<span style="text-align:center;" class="fb-txt-gray fb-ancho20">';
						       ...
						       if(!empty($groupini)){
								...
								$html.='</span><span style="text-align:center;" class="fb-txt-gray fb-ancho20">';
								...
								$html.='</span>';
								if($grade->fgrade>=14){
									$html.='<span style="text-align:center;" class="fb-ancho10 fb-nota-aprobada">'.$grade->fgrade.'</span>';

								}else{
	                                 $html.='<span style="text-align:center;" class="fb-ancho10 fb-nota-desaprobada">'.$grade->fgrade.'</span>';
								}
